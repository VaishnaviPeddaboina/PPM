    ...
    public class ProjectConsoles
    {
        public static void ProjectModule()
        {
            ...
            do
            {
                ...
                Console.WriteLine("           7.View Employees in Project            ");
                ...
                switch (selectOption)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        ProjectEmployeeConsoles.AddEmployeeToproject();
                        break;
                    case 6:
                        ProjectEmployeeConsoles.DeleteemployeefromProject();
                        break;
                    case 7:
                        ProjectEmployeeConsoles.ViewEmployeesinProject();
                        break;
                    case 8:
                        return;
